<navbar class="fixed z-20 w-full bg-[#F7F6F2] backdrop-blur bg-opacity-60 border-b-2 border-black">
    <div class="container mx-auto gap-[85px] px-2 lg:flex lg:items-center lg:justify-between">
        <div class="flex justify-between">
            {{-- Kiri --}}
            <div class="">
                <a href="/"><img class="w-32" src="{{ asset('img/alatanlogo.png') }}" alt="Logo"></a>
            </div>
