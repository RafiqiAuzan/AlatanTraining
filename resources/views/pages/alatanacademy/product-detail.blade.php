            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a href="/publictraining" class="ms-1 text-xs font-medium text-[#001C30] hover:text-[#3652AD] md:ms-2">Public Training</a>
                </div>
              </li>
              <li>
                <div class="flex items-center">
                    <i class="fa-solid fa-chevron-right"></i>
                  <a href="/publictraining" class="ms-1 text-xs font-medium text-[#001C30] hover:text-[#3652AD] md:ms-2">Digital Marketing</a>
                </div>
              </li>
...
<Section>
    <div class="bg-[#F3F3F3] px-12 py-4">
        <div class="flex justify-between gap-10 container mx-auto">
            <div class="">
                <h1 class=" text-[#001C30] text-3xl font-bold mb-3">Perhitungan Estimasi TKDN Pada Pengadaan Barang/Jasa Pemerintah</h1>
                ...
                <div class="flex gap-2 divide-x-2 divide-[#818080] mb-3">
                    <div class="flex gap-2 px-2">
                        <i class="fa-solid fa-calendar-days text-[#3652AD] my-auto"></i>
                        <p>29 February - 2 March 2024</p>
                    </div>        
                    <div class="flex gap-2 px-2">
                        <i class="fa-solid fa-clock text-[#3652AD] my-auto"></i>
                        <p>09:00 - 16:00 WIB</p>
                    </div>
                    <div class="flex gap-2 px-2">
                        <i class="fa-solid fa-location-dot text-[#3652AD] my-auto"></i>
                        <p>Ashley Wahid Hasyim, Jakarta</p>
                    </div>
                </div>
                <div class="flex gap-2 my-3">
                    <div class="flex gap-2 border-2 px-2 p-1 rounded-full">
                        <i class="fa-solid fa-layer-group text-[#3652AD] my-auto"></i>
                        <p class="text-[#001C30]">Digital Marketing</p>
                    </div>        
                    <div class="flex gap-2 border-2 px-2 p-1 rounded-full">
                        <i class="fi fi-sr-search-alt text-[#3652AD] my-auto"></i>
                        <p class="text-[#001C30]">Online Class</p>
                    </div>
                </div>
                <div class="grid gap-2 mb-3">
                    <p class=" text-[#001C30] font-medium text-xl">Description</p>
                    <p class=" text-[#001C30] text-base">Penjelasan Product, Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    <p class=" text-[#001C30] text-base">It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                </div>
                <div class="border-2 rounded-lg p-2 grid gap-2 ">
                    <p class=" text-[#001C30] font-medium text-xl">Materi</p>
                    <p>Konsep Umum Environment Social Governance:</p>
                    <div class="max-w-[580px] gap-2 grid ml-2">
                        <div class="flex gap-1 my-auto ">
                            <i class="mt-0.5 text-[#3652AD] fa-solid fa-circle-check"></i>
    ...
    <div class="bg-[#EEEEEE] px-12 py-6">
        <div class="container mx-auto">
            ...
            <div class="px-64 grid gap-3">
                {{-- Questions --}}
                <div class="border p-2 grid gap-4 border-1 rounded-xl text-[#001C30] border-[#001C30] bg-[#F3F3F3]">
                    <div class="flex justify-between">
                        <p>What is an online course?</p>
                        <i class="fa-solid fa-x my-auto"></i>
                    </div>
                ...
                {{-- Questions --}}
                <div class="border p-2 grid gap-4 border-1 rounded-xl border-black bg-[#F3F3F3]">
                    <div class="flex justify-between text-[#001C30]">
                        <p>How do I enroll in an online course?</p>
                        <i class="fa-solid fa-chevron-down my-auto"></i>
                    </div>
                </div>
                {{-- Questions --}}
                <div class="border p-2 grid gap-4 border-1 rounded-xl text-[#001C30] border-black bg-[#F3F3F3]">
                    <div class="flex justify-between">
