<x-layouts.auth title="Alatan Indonesia">
    ...
    <div class="relative bg-[#F3F3F3] h-screen">
        <img src="img/auth/wallpaper.jpg" class="absolute inset-0 w-full h-full object-cover" alt="Background Image">
        <div
            class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[500px] bg-[#EEEEEE]/80 rounded-2xl">
            <button id="backButton" type="button"
    class="mt-4 ml-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    <i class="fa-solid fa-arrow-left"></i>
</button>
            
            <img src="img/logo/logo_alatan_biru.svg" class=" h-28 mx-auto mb-2" alt="Logo">
            <form class="py-4 px-10">
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <label for="floating_email"
                        class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 bg-transparent transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Email
                        address</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
