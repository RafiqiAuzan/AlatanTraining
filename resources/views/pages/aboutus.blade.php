    ...
    <div class="bg-[#F3F3F3] px-12">
        <div class="container mx-auto py-4">
            ...
            <div class="flex gap-3 justify-center">
                <!-- Left -->
                <div class="items-end">
                    <img class="" src="{{ URL::to('/img/aboutus/creative.svg') }}">
                </div>
                <!-- Right -->
                <div class="max-w-[500px] my-auto">
                    <p class="stext-base text-[#52616B] leading-normal">Alatan Training (PT Alatan Asasta Indonesia)
                        adalah lembaga pelatihan dan pengembangan
                        SDM. Sejak 2023 telah aktif memberikan Pelatihan
                        dan Pengembangan SDM bagi para karyawan,
                        pegawai negeri, dan umum dengan pembelajaran
                        secara online maupun offline.
                        </p><br>
                        <p class="stext-base text-[#52616B] leading-normal">Alatan training memberikan pelatihan offline dan
                            online yang bertujuan untuk meningkatkan
                            softskill dan hardskill yang dibutuhkan dalam
                            pekerjaan dan pengembangan karir.</p>
                </div>
            </div>
        </div>
    </div>
...
<Section>
    <div class="bg-[#EEEEEE] px-12">
        <div class="container mx-auto grid grid-cols-2 gap-3 py-4 justify-between">
            ...
            <!-- Right -->
            <div class="">
                <img class="ml-auto" src="{{ URL::to('/img/aboutus/Notebook.svg') }}">
            </div>
        </div>
    </div>
</Section>
        ...
        <div class="container mx-auto grid grid-cols-2 gap-5 justify-between">
            ...
            <div class="grid gap-3">
                ...
                <p class="text-[#52616B] text-base">At mattis tincidunt ac scelerisque fermentum ultricies sit morbi.
                    ...
                    eget leo at in fermentum id at. Id porttitor diam dolor orci ultrices.</p>
            </div>
            <!-- Right -->
            <div class="grid gap-3">
                <div class="flex gap-2 my-auto">
                ...
                <img class="mx-auto" src="{{ URL::to('/img/aboutus/Mission.svg') }}">
            </div>
        </div>
    </div>
</Section>
...
<Section>
    <div class="bg-[#F3F3F3] p-12">
        <div class="flex gap-10 justify-center">
            ...
            <!-- Right -->
            <div class="items-end">
                <img class="w-[350px]" src="{{ URL::to('/img/aboutus/Product-quality.svg') }}">
            </div>
        </div>
    </div>
</Section>
