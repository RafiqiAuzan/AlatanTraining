<x-layouts.base title="Memorials Studio">
    ...
    <div id="hero" class=" bg-[#F7F6F2]">
        <div class="h-screen mx-auto grid grid-cols-2 items-center">
            <div class="ml-48">
                <!-- Konten Anda disini -->
                <h1 class="text-[80px] leading-none font-bold px-10">Alatan Training for Skill Growth</h1>
                <br><br>
                <p class="text-[20px] leading-normal pl-10">Alatan Training memberikan program pengembangan Sumber Daya Manusia dengan didukung oleh para tenaga pengajar (trainer) berpengalaman.</p>
            </div>
